...
| [pi-herdr-workflow-kit](https://github.com/Jackliu-miaozi/pi-herdr-workflow-kit) ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white&style=flat-square) | Gated planner → coder → reviewer pipeline |
| [mcdonc-pi-herdr](https://github.com/mcdonc/mcdonc-pi-herdr) ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white&style=flat-square) | Background Pi tasks into panes & tabs |
...
| [herdr-mesh](https://github.com/runchr-works/herdr-mesh) ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white&style=flat-square) | MCP tools for agent-to-agent orchestration |
...
| [herdr.nvim](https://github.com/devxplay/herdr.nvim) ![Lua](https://img.shields.io/badge/-Lua-2C2D72?logo=lua&logoColor=white&style=flat-square) | Neovim ↔ Herdr pane navigation |
| [switchr](https://github.com/ridho9/switchr) ![Go](https://img.shields.io/badge/-Go-00ADD8?logo=go&logoColor=white&style=flat-square) | TUI session picker with pane tree |
| [herdrctx](https://github.com/j0urneyk/herdrctx) ![Go](https://img.shields.io/badge/-Go-00ADD8?logo=go&logoColor=white&style=flat-square) | TUI to attach, stop, manage sessions |
...
| [superherd](https://github.com/SirTenzin/superherd) ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white&style=flat-square) | Bridge Superset workspaces into Herdr |
...
| [herdr-dotfiles](https://github.com/Taeyoung96/herdr-dotfiles) ![Shell](https://img.shields.io/badge/-Shell-4EAA25?logo=gnubash&logoColor=white&style=flat-square) | Drop-in config: prefix-free navigation |
| [herdr-menu-bar](https://github.com/hmu332233/herdr-menu-bar) ![Swift](https://img.shields.io/badge/-Swift-FA7343?logo=swift&logoColor=white&style=flat-square) | macOS menu-bar agent-status widget |
| [deepin-herdr](https://github.com/re2zero/deepin-herdr) ![C++](https://img.shields.io/badge/-C%2B%2B-00599C?logo=cplusplus&logoColor=white&style=flat-square) | Native Deepin Linux window for Herdr |
| [herdr-nix](https://github.com/AodhanHayter/herdr-nix) ![Nix](https://img.shields.io/badge/-Nix-5277C3?logo=nixos&logoColor=white&style=flat-square) | Nix flake, auto-updated, with binary cache |
...
A standalone fork of Herdr by Masakiro Corp, shipping as its own `hako` binary with a separate config and namespace so it can run alongside upstream. It tracks Herdr commit-by-commit via a formal port map and adds its own touches — most notably Arc-style workspace groups — making it a real product build rather than a frozen clone.
...
**[Jackliu-miaozi/pi-herdr-workflow-kit](https://github.com/Jackliu-miaozi/pi-herdr-workflow-kit)** ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white&style=flat-square)
...
**[mcdonc/mcdonc-pi-herdr](https://github.com/mcdonc/mcdonc-pi-herdr)** ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white&style=flat-square)
...
**[runchr-works/herdr-mesh](https://github.com/runchr-works/herdr-mesh)** ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white&style=flat-square)
...
**[devxplay/herdr.nvim](https://github.com/devxplay/herdr.nvim)** ![Lua](https://img.shields.io/badge/-Lua-2C2D72?logo=lua&logoColor=white&style=flat-square) ![Rust](https://img.shields.io/badge/-Rust-DEA584?logo=rust&logoColor=black&style=flat-square)
...
**[ridho9/switchr](https://github.com/ridho9/switchr)** ![Go](https://img.shields.io/badge/-Go-00ADD8?logo=go&logoColor=white&style=flat-square)
...
**[j0urneyk/herdrctx](https://github.com/j0urneyk/herdrctx)** ![Go](https://img.shields.io/badge/-Go-00ADD8?logo=go&logoColor=white&style=flat-square)
...
**[SirTenzin/superherd](https://github.com/SirTenzin/superherd)** ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white&style=flat-square)
...
**[Taeyoung96/herdr-dotfiles](https://github.com/Taeyoung96/herdr-dotfiles)** ![Shell](https://img.shields.io/badge/-Shell-4EAA25?logo=gnubash&logoColor=white&style=flat-square)
...
**[hmu332233/herdr-menu-bar](https://github.com/hmu332233/herdr-menu-bar)** ![Swift](https://img.shields.io/badge/-Swift-FA7343?logo=swift&logoColor=white&style=flat-square)
...
**[re2zero/deepin-herdr](https://github.com/re2zero/deepin-herdr)** ![C++](https://img.shields.io/badge/-C%2B%2B-00599C?logo=cplusplus&logoColor=white&style=flat-square)
...
**[AodhanHayter/herdr-nix](https://github.com/AodhanHayter/herdr-nix)** ![Nix](https://img.shields.io/badge/-Nix-5277C3?logo=nixos&logoColor=white&style=flat-square)
...
**[SuperInstance/herdr-cocapn](https://github.com/SuperInstance/herdr-cocapn)** ![Rust](https://img.shields.io/badge/-Rust-DEA584?logo=rust&logoColor=black&style=flat-square)
...
**Releases.** Herdr moves fast. Recent ecosystem-relevant additions include indexed keybind families (`[keys.indexed]`), terminal-backed agent socket methods, direct terminal attach, manual pane labels (`pane.rename`), and remote attach (`herdr --remote`). Always check the upstream [releases](https://github.com/ogulcancelik/herdr/releases) for the version your project depends on.
